				...
				<div class="NewContainer770">
					...
					<div class="Slot">
						<table width="100%" border="0">
						    <tr>
						       <td align="center"><s:property value="#request.zhengwu.title" escape="false"/></td>
						    </tr>
						    <tr>
						       <td align="center"><hr></td>
						    </tr>
						    <tr>
						       <td align="center"><s:property value="#request.zhengwu.content" escape="false"/></td>
						    </tr>
						    <tr>
						       <td align="center"><hr></td>
						    </tr>
						    <tr>
						       <td align="right"><s:property value="#request.zhengwu.shijian"/></td>
						    </tr>
						</table>
                    </div>
				</div>
